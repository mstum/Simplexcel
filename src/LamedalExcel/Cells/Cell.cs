...
using LamedalExcel.XlsxInternal;

namespace LamedalExcel.Cells
{
    /// <summary>
    ...
    public sealed class Cell
    {
        ...
        public Cell(enCellType cellType) : this(cellType, null, BuiltInCellFormat.General) { }
        ...
        public Cell(enCellType type, object value, string format)
        {
        ...
        [DataMember]
        public enCellType CellType { get; private set; }
        ...
        {
            return new Cell(enCellType.Text, value, BuiltInCellFormat.Text);
        }
        ...
        {
            return new Cell(enCellType.Number, Convert.ToDecimal(value), BuiltInCellFormat.NumberNoDecimalPlaces);
        }
        ...
        {
            return new Cell(enCellType.Number, value, BuiltInCellFormat.NumberTwoDecimalPlaces);
        }
        ...
        {
            return new Cell(enCellType.Number, Convert.ToDecimal(value), BuiltInCellFormat.NumberTwoDecimalPlaces);
        }
    }
}
